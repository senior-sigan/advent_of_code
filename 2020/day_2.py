...
def count(letter: str, password: str) -> int:
    counter = 0
...
def task_1(lines):
    ok_counter = 0
    for line in lines:
        min_, max_, letter, password = parse(line)
        counter = count(letter, password)
...
def task_2(lines):
    ...
    for line in lines:
        ...
        check_a = password[a-1] == letter
        check_b = password[b-1] == letter
